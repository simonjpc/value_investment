...
for idx, test_symbol in enumerate(filtered_tickers):
    ...
    for i, date in enumerate(dates):
        ...
        output_df.loc[idx, "ncav_mos"] = round(100 * (ncavps - oldest_lowest_price) / ncavps, 2)
        output_df.loc[idx, "liqv_mos"] = round(100 * (liqvps - oldest_lowest_price) / liqvps, 2)
        ...
        output_df.loc[idx, "ncav_mos_modif"] = round(100 * (ncavps - output_df.loc[idx, "min_price_modif"]) / ncavps, 2)
        output_df.loc[idx, "liqv_mos_modif"] = round(100 * (liqvps - output_df.loc[idx, "min_price_modif"]) / liqvps, 2)
